...
SAMPLE_RATE = 16000
DURATION = 4  # seconds
CSV_FILE = "exp1_google_sr.tsv"   # TSV for locale safety
...
# =========================
# Initialize Google SR
# =========================
recognizer = sr.Recognizer()

print("\nExperiment 1 – Google Speech Recognition")
print("Keyword-based Command Execution")
...
try:
    while True:
        ...
        # Convert NumPy audio to AudioData for Google SR
